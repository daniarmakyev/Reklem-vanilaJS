            ...
            <div class="container">
                <form id="userDataForm">
                    <ul style="list-style: none; margin-top: 150px; max-width: 700px; margin-left: auto; margin-right: auto;">
                        ...
                        <li><span style="font-size: 14px; font-weight: 600; line-height: 20px; color: rgb(216, 123, 0); margin-bottom: 25px; display: inline-block;">Пароль</span><input type="text" name="address" value="${user.password || ''}" readonly></li>
